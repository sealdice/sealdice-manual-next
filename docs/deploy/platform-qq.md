...
::: warning
请注意，如果你想使用 shamrock 代替 gocq，请确保你有一个良好的计算机使用基础。并且，由于模拟器较消耗系统性能，老式电脑可能并不能完成任务，***包括轻量级服务器***
:::

::: info
本节主要讲解如何使用模拟器实现 shamrock，如果你有一台已经 root 的手机，也可以参考本节内容，本教程不提供如何 root 手机。
:::
...
- 随后你需要去找模拟器供 adb 连接的端口，对于我的电脑是这个路径![shamrock](./images/platform-qq-shamrock-6.png)
  - nox 是模拟器根路径
